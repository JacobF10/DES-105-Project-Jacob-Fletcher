...
{//Copied from Youtube Unity Tutorial: Following an object
    ...
    void MoveToTarget() {
        MyDirection = (myTarget.position - transform.position).normalized;
        transform.Translate(MyDirection * Time.deltaTime * MySpeed);
